...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  int id, @HiveField(1)  int userId, @HiveField(2)  String name, @HiveField(3)@JsonKey(name: 'balance', fromJson: _balanceFromJson, toJson: _balanceToJson)  double balance, @HiveField(4)  String currency, @HiveField(5)  DateTime createdAt, @HiveField(6)  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BankAccount() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  int id, @HiveField(1)  int userId, @HiveField(2)  String name, @HiveField(3)@JsonKey(name: 'balance', fromJson: _balanceFromJson, toJson: _balanceToJson)  double balance, @HiveField(4)  String currency, @HiveField(5)  DateTime createdAt, @HiveField(6)  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _BankAccount():
return $default(_that.id,_that.userId,_that.name,_that.balance,_that.currency,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)  int id, @HiveField(1)  int userId, @HiveField(2)  String name, @HiveField(3)@JsonKey(name: 'balance', fromJson: _balanceFromJson, toJson: _balanceToJson)  double balance, @HiveField(4)  String currency, @HiveField(5)  DateTime createdAt, @HiveField(6)  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _BankAccount() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.balance,_that.currency,_that.createdAt,_that.updatedAt);case _:
  return null;
