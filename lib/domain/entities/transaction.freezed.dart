...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  int id, @HiveField(1)  int accountId, @HiveField(2)  int categoryId, @HiveField(3)@JsonKey(fromJson: _amountFromJson)  double amount, @HiveField(4)  DateTime transactionDate, @HiveField(5)  String comment, @HiveField(6)  DateTime createdAt, @HiveField(7)  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppTransaction() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  int id, @HiveField(1)  int accountId, @HiveField(2)  int categoryId, @HiveField(3)@JsonKey(fromJson: _amountFromJson)  double amount, @HiveField(4)  DateTime transactionDate, @HiveField(5)  String comment, @HiveField(6)  DateTime createdAt, @HiveField(7)  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _AppTransaction():
return $default(_that.id,_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.comment,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)  int id, @HiveField(1)  int accountId, @HiveField(2)  int categoryId, @HiveField(3)@JsonKey(fromJson: _amountFromJson)  double amount, @HiveField(4)  DateTime transactionDate, @HiveField(5)  String comment, @HiveField(6)  DateTime createdAt, @HiveField(7)  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _AppTransaction() when $default != null:
return $default(_that.id,_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.comment,_that.createdAt,_that.updatedAt);case _:
  return null;
